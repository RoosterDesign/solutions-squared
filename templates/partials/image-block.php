      ...
      <ul class="image-block-nav">
        ...
        ?>
          <li class="image-block-nav__item">
            <a href="#<?php echo $blockID['content']; ?>_<?php the_field('subsection_id'); ?>" title="<?php the_field('subsection_buttonLabel'); ?>" class="<?php echo $cssClass;?>" data-link-parent="<?php echo $blockID['content']; ?>"><?php the_field('subsection_buttonLabel'); ?><span class="btn__chevron"></span></a>
          </li>
