<section class="image-block<?php if( $blockID['image_mask']) : ?> -hasMask<?php endif; ?>" id="<?php echo $blockID['content']; ?>" style="background-image: url('https://placeimg.com/1000/500/nature')"> 
